...
void on_ready(struct discord *client, const struct discord_ready *event) {
  ...
  discord_create_guild_application_command(client, APP_ID, GUILD_ID, &skip,
                                           NULL);
  discord_create_guild_application_command(client, APP_ID, GUILD_ID, &stop,
                                           NULL);
  discord_create_guild_application_command(client, APP_ID, GUILD_ID,
                                           &pause_play, NULL);
  discord_create_guild_application_command(client, APP_ID, GUILD_ID, &get_queue,
                                           NULL);
  discord_create_guild_application_command(client, APP_ID, GUILD_ID, &pop_queue,
                                           NULL);
  discord_create_guild_application_command(client, APP_ID, GUILD_ID, &test,
                                           NULL);
}
